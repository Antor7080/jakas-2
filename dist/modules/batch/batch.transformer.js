...
const transformedEntity = (params, role) => {
...
const resEntity = (batchInfo, role) => {
    const totalDeath = batchInfo.mortality
        ? batchInfo.mortality.reduce((a, b) => a + b.count, 0)
        : 0;
    ...
    if (role === "admin" ||
        ...
        role === "feedSaller" ||
        role === "doctor") {
        farmer = Object.assign({}, batchInfo.farmer);
    }
    const entity = {
        _id: batchInfo._id,
...
//# sourceMappingURL=batch.transformer.js.map